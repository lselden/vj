...
*/
Seriously.plugin('blend2', (function () {
	var modes = {
		'normal': 'BlendNormal',
...
//				'#define BlendOpacity(base, blend, F, O)	(F(base, blend) * O + blend * (1.0 - O))\n' +
				'#define BlendOpacity(base, blend, F, O, A)	((F(vec3(base.rgb * blend.a * O), vec3(blend.rgb * blend.a * O)) + base.rgb * base.a * (1.0 - blend.a * O)) / A)\n' +
				'\n' +
				...
				//'	float alpha = topPixel.a + bottomPixel.a;\n' +
				//'	if (alpha == 0.0) {\n' +
				//'		color = vec3(0.0);\n' +
				//'	} else {\n' +
				'	color = BlendOpacity(bottomPixel, topPixel, BlendFunction, opacity, 1.0);\n' +
